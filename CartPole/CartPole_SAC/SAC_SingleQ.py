...
class Critic(nn.Module):
    def __init__(self, input_dim, output_dim):
        ...
        self.fc1 = nn.Linear(input_dim, 128)
        self.reward = nn.Linear(128, output_dim)
            ...
            while not done:
                ...
                if len(replay_buffer) >= batch_size and steps % update_every == 0:
                    ...
                    with torch.no_grad():
                        ...
                        q_next = critic(next_state_batch)

                        entropy_term = alpha * next_log_probs
                        weighted_q_values = next_probs * (q_next - entropy_term)
                    ...
                    # Critic loss
                    critic_loss = F.mse_loss(q_action, target_q)
                    ...
                    # Actor loss
                    inside_term = alpha * log_probs - q_values
